...
This v1.1 package includes a `.python-version` file set to `3.12.8` and removes NumPy from the deploy path. This avoids slow or stuck `Preparing metadata...` dependency builds on Render's newer default Python runtime.
